...
public class TabAddShoesComponent extends JPanel{
    ...
    private void initComponents(int widthWindow) {
        ...
        captionComponent = new CaptionComponent("Добавление нового товара", widthWindow, 31);
        this.add(captionComponent);
        infoComponent = new InfoComponent("", widthWindow, 31);
        this.add(infoComponent);
        this.add(Box.createRigidArea(new Dimension(0,10)));
        shoesNameComponent = new EditorComponent("Название", widthWindow, 31, 300);
        ...
        buttonComponent = new ButtonComponent("Добавить", widthWindow, 31, 350, 150);
